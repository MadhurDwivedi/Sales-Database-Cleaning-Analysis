...
# 1- It should ask for datasets path and name,
# 2- It should check number of duplicats and remove all the duplicates,
# 3- It should keep a copy of all the duplicates,
# 4- It should check for missing values,
# 5- If any column that is numeric it should replace nulls with mean else it should drop that rows,
# 6- At end it should save the data as clean data and also return duplicates records, clean_data.
